...
class DsProductConfigurationResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets price_category
     *
     * @param string $price_category It is only set if there are no travelers or all travelers do have the same priceCategory
     *
     * @return $this
     */
     ...
     *
     * @param string $price_category_name It is only set if there are no travelers or all travelers do have the same priceCategory
     *
     * @return $this
     */
